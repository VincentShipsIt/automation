...
| `board-hygiene` | Keep GitHub issues and project board fields current without creating duplicate issue/card work. | Daily or twice daily on active projects. | Codex local `board-hygiene`; Claude local `board-hygiene`; Claude remote `board-hygiene`. |
